...
- تسجيل دخول JWT وتحديث/تطبيق التوكن.
- لوحة قياس سريعة (health + أعداد العملاء/المواد/الفواتير/السندات).
- صفحات اختبار عملية لـ:
  - العملاء
  - الحسابات وكشف الحساب
  - المواد وصور المواد
  - الفواتير والسندات (قائمة + تفاصيل)
- API Explorer عام لإرسال أي طلب مخصص (GET/POST/PUT/DELETE) مع query/body.
