...
وعند غياب ربط مباشر في جداول العلاقات، يحاول النظام قراءة نوع القيد من `en000.TypeGUID` (مثل: قبض/دفع/مبيع/شراء) مع إرجاع رقم المرجع من `ParentNumber` أو رقم القيد.
