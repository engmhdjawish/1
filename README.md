...
الواجهة توفر تجربة قريبة من المنتج النهائي:

- تسجيل دخول JWT وإدارة جلسة المستخدم.
- لوحة تحكم بمؤشرات رئيسية (health + أعداد العملاء/المواد/الفواتير/السندات).
- شاشة مستندات (فواتير/سندات) بنمط master-detail مع فلترة سريعة وأنواع ديناميكية.
- شاشة مواد ببطاقات وصور وتفاصيل المادة.
