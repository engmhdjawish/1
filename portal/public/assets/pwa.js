  ...
  function copyForMode(mode) {
    ...
    if (mode === 'http') {
      return {
        ...
        steps: [
          'الرابط الحالي غير آمن (HTTP) — المتصفح لا يفعّل التثبيت التلقائي.',
          'افتح الموقع عبر https:// مع شهادة SSL صالحة.',
          'أو من Chrome: القائمة ⋮ → «تثبيت التطبيق» / «إضافة إلى الشاشة الرئيسية».',
        ],
        button: null,
      };
    }
