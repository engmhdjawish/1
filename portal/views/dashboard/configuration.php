...
<section class="mb-6">
  <div class="flex flex-wrap items-start justify-between gap-3">
    <div>
      <h1 class="text-2xl font-extrabold text-slate-900">إدارة النظام</h1>
      <p class="text-sm text-text-muted mt-1 max-w-2xl">
        إعدادات تقنية وإدارية: المستخدمون، سياسات الوصول، وربط الأمين وقاعدة البيانات.
        لتحرير محتوى الموقع العام انتقل إلى
        <a href="/dashboard/site-content.php" class="text-primary font-bold hover:underline">محتوى الموقع</a>.
      </p>
    </div>
      ...
      <?php foreach ($items as $item): ?>
        ...
        >
          <div class="flex items-center gap-3">
            <span class="w-11 h-11 rounded-xl bg-surface-low text-slate-700 flex items-center justify-center group-hover:bg-slate-800 group-hover:text-white transition">
            ...
            <div>
              ...
              <p class="text-xs text-text-muted mt-0.5">إدارة النظام</p>
            </div>
          </div>
