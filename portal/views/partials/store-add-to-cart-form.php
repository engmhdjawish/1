...
>
  ...
  <div class="store-add-cart__in-cart"<?= $inCart ? '' : ' hidden' ?>>
    ...
    <div class="store-card-cart-bar">
      ...
      <div class="store-card-cart-bar__qty-locked"<?= $canAdjustInCart ? ' hidden' : '' ?>>
        <strong class="store-num" dir="ltr" data-cart-qty-display"><?= h(format_packages_display($cartQtyForItem)) ?></strong>
        <span><?= h($packageUnit) ?></span>
      </div>

      <div class="store-qty-stepper store-qty-stepper--inline" data-cart-qty-adjust<?= $canAdjustInCart ? '' : ' hidden' ?>>
