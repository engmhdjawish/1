...
?>
<form method="post" action="/dashboard/orders.php" class="dashboard-order-line__form" data-dashboard-ajax data-dashboard-reload>
...
<form method="post" action="/dashboard/orders.php" class="dashboard-order-line__form dashboard-order-line__form--danger" data-dashboard-ajax data-dashboard-reload data-dashboard-confirm="إلغاء هذا الصنف من الطلب؟ سيظهر التغيير للعميل.">
  <input type="hidden" name="order_id" value="<?= h($orderId) ?>">
  <input type="hidden" name="item_id" value="<?= h($itemId) ?>">
