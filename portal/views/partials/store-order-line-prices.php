...
<div class="store-order-line-prices store-order-line-prices--<?= h($size) ?>">
  <?php if ($showPriceSyp && ($prices['pack_sp'] > 0 || $prices['orig_pack_sp'] > 0 || $prices['unit_sp'] > 0)): ?>
    <?php if ($prices['unit_sp'] > 0): ?>
      <div class="store-order-line-prices__row store-order-line-prices__row--main">
        ...
        <div class="store-order-line-prices__values">
          ...
          <?php endif; ?>
          <span class="store-order-line-prices__amount store-num" dir="ltr"><?= format_money($prices['unit_sp'], true) ?> <small>ل.س</small></span>
        </div>
      </div>
    <?php endif; ?>
    <?php if ($prices['pack_sp'] > 0 || $prices['orig_pack_sp'] > 0): ?>
      <div class="store-order-line-prices__row">
        ...
        <div class="store-order-line-prices__values">
          ...
          <?php endif; ?>
          <span class="store-order-line-prices__amount store-order-line-prices__amount--pack store-num" dir="ltr"><?= format_money($prices['pack_sp'], true) ?> <small>ل.س</small></span>
        </div>
      </div>
    <?php endif; ?>
  <?php elseif ($showPriceUsd && ($prices['pack_usd'] > 0 || $prices['orig_pack_usd'] > 0 || $prices['unit_usd'] > 0)): ?>
    <?php if ($prices['unit_usd'] > 0): ?>
      <div class="store-order-line-prices__row store-order-line-prices__row--main">
        ...
        <div class="store-order-line-prices__values">
          ...
          <?php endif; ?>
          <span class="store-order-line-prices__amount store-num" dir="ltr">$<?= number_format($prices['unit_usd'], 2, '.', ',') ?></span>
        </div>
      </div>
    <?php endif; ?>
    <?php if ($prices['pack_usd'] > 0 || $prices['orig_pack_usd'] > 0): ?>
      <div class="store-order-line-prices__row">
        <span class="store-order-line-prices__label"><?= h($prices['package_unit']) ?></span>
        <div class="store-order-line-prices__values">
          ...
          <?php endif; ?>
          <span class="store-order-line-prices__amount store-order-line-prices__amount--pack store-num" dir="ltr">$<?= number_format($prices['pack_usd'], 2, '.', ',') ?></span>
        </div>
      </div>
    <?php endif; ?>
  <?php endif; ?>
