...
<div class="store-order-line-prices store-order-line-prices--<?= h($size) ?>">
  <?php if ($showPriceSyp && ($prices['pack_sp'] > 0 || $prices['unit_sp'] > 0)): ?>
  ...
  <?php elseif ($showPriceUsd && ($prices['pack_usd'] > 0 || $prices['unit_usd'] > 0)): ?>
